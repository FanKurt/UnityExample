...
public class UIDragObject : IgnoreTimeScale
{
	...
	void LateUpdate ()
	{
		...
		if (gameObject.transform.localPosition.x > 370) {
			gameObject.transform.localPosition = new Vector3( 370, y, z );
		}
		if (gameObject.transform.localPosition.y > 220) {
			gameObject.transform.localPosition = new Vector3( x, 220, z );
		}
		if (gameObject.transform.localPosition.x < 85) {
			gameObject.transform.localPosition = new Vector3( 85, y, z );
		}
		if (gameObject.transform.localPosition.y < -225) {
			gameObject.transform.localPosition = new Vector3( x, -225, z );
		}
	}
